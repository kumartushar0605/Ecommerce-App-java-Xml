package com.example.red.Models;
...
public class Product implements Item, Serializable {
    // here we have to implements the item and the serializable interface and implements the method so this libraray completes the complete the entire code of a cart
